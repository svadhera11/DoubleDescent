...
#SBATCH --job-name=resnet_allconfigs
...
CUDA_VISIBLE_DEVICES=0 bash scripts/run_config1_resnet.sh &
CUDA_VISIBLE_DEVICES=1 bash scripts/run_config2_resnet.sh &
CUDA_VISIBLE_DEVICES=2 bash scripts/run_config3_resnet.sh &
CUDA_VISIBLE_DEVICES=3 bash scripts/run_config4_resnet.sh &
