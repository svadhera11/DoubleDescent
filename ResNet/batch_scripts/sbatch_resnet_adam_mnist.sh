...
CUDA_VISIBLE_DEVICES=0 bash scripts/run_config2_resnet_adam_mnist_0.sh &
CUDA_VISIBLE_DEVICES=1 bash scripts/run_config2_resnet_adam_mnist_1.sh &
CUDA_VISIBLE_DEVICES=2 bash scripts/run_config2_resnet_adam_mnist_2.sh &
CUDA_VISIBLE_DEVICES=3 bash scripts/run_config2_resnet_adam_mnist_3.sh &
